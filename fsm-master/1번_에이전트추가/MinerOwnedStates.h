...
//  to QuenchThirst
//------------------------------------------------------------------------
class EnterMineAndDigForNugget : public State<Miner> //±¤ºÎ ±¤»ê
{
private:
...
public:
  ...
  //this is a singleton
  static EnterMineAndDigForNugget* Instance(); //½Ì±ÛÅæ

  virtual void Enter(Miner* miner); //µé¾î°¥¶§

  virtual void Execute(Miner* miner); //ÁøÇàÇÒ¶§

  virtual void Exit(Miner* miner); //³ª°¥ ¶§

  virtual bool OnMessage(Miner* agent, const Telegram& msg); //¸Þ½ÃÁö
